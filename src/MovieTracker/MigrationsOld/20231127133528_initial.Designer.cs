...
namespace MovieTracker.Migrations
{
    ...
    [Migration("20231127133528_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTracker.Models.CommentRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MovieTracker.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("MovieTracker.Models.Comment", b =>
                {
                    b.HasOne("MovieTracker.Models.AppUser", "AppUser")
                        .WithMany()
                    ...
                    b.HasOne("MovieTracker.Models.Comment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("MovieTracker.Models.CommentRating", b =>
                {
                    ...
                    b.HasOne("MovieTracker.Models.Comment", "Comment")
